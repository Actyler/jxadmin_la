...
return [
	...
	//小程序配置
	'mini_program'			=> [
		'app_id' => 'wxc53871abb8adf',					//小程序appid
		'secret' => '725d9e7e7162a4c60355d708543',		//小程序secret
	],
	...
	'wechart_pay'			=> [
		...
		'cert_path'      => base_path().'extend/utils/wechart/zcerts/apiclient_cert.pem',	//证书路径
		'key_path'       => base_path().'extend/utils/wechart/zcerts/apiclient_key.pem',	//证书路径
		'rsa_public_key_path'  => base_path().'extend/utils/wechart/zcerts/public.pem',	//rsa公钥
	],
	...
	'list_title_status'=> true,	//列表页面标题 true开启 false关闭
